...
%% The AAS Journals now use Unified Astronomy Thesaurus (UAT) concepts:
%% https://astrothesaurus.org
%% You will be asked to select these concepts during the submission process
%% but this old "keyword" functionality is maintained in case authors want
%% to include these concepts in their preprints.
%%
%% You can use the \uat command to link your UAT concepts back to their source.
...
%% Overview of our current understanding of the topic in galaxy evolution, broadly.
...
%% Introduce your specific project
...
%% Which of the open questions (paragraph 4 of the intro) does this project address?

%% Why is this open question an important problem to solve for our understanding of Galaxy Evolution? How will your study help us to address the open question?

\section{Methodology}
%% Start with an introduction to the simulations you are using. You must reference the paper associated with the simulations and describe what is meant by an “N-body” simulation. Describe how each galaxy is initially modeled (Dark matter halo with what profile, disk, etc).

%% Overview your approach. What particle types are you using, what resolution of the simulation data (VLowRes, LowRes, HighRes).

%% Include a figure to explain what you are trying to do. This figure can be from a published paper or can be a detailed diagram you created to describe your logic. The figure must have a caption, follow guidelines for the caption as listed for Figure 1. If you are using a figure from a published paper you cannot copy the caption from that paper.

%% Describe the calculations your code will compute. You must include all relevant equations and citations, and describe the meaning behind every parameter in the equation (e.g. The circular speed is defined as V 2 c = GM/r, where M is the Mass of the host galaxy (M⊙) and r is the Galactocentric radius (kpc))
...
%% Describe the plots you will need to create and explain why those plots will answer your question.
...
%% Describe your hypothesis for what you think you will find. Explain your motivation for this hypothesis.
...
\section{Results}
%% Paragraphs 1 and 2: Describe each of the two figures (Figures 3, 4) that you have created from your code. One paragraph per figure. End each paragraph with the main take away result

%% Figure 3: Figure from previous code in class
\begin{figure}[ht!]
	\centering
...
%% Figure 4: Figure created from new code
\begin{figure}
    \centering
...
%% Each figure must have a detailed caption where everything plotted is explained, including axis labels and line types/colors. Include in the caption a punchline for each figure that explains what the reader should take away.

\section{Discussion}
%% Paragraph 1: Summarize one result from the previous section. Does this result agree or disagree with your hypothesis?

%% Paragraph 2: How does the result from Paragraph 1 relate to existing work in the literature? E.g. the papers you cited in the introduction. What is the importance/meaning of this result for our understanding of galaxy evolution?

%% Paragraph 3: What are the uncertainties in your analysis?

%% Repeat these paragraphs if there is another result
...
\bibliography{QUIRK_ResearchAssignment6}{}
